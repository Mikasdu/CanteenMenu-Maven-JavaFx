...
public enum AlertMessage {
    ...
    ERROR_CONNECTION(Alert.AlertType.ERROR, "Connection error", "Nepavyko prisijungti prie duomenų bazės"),
    ...
    CONFIRM_DELETE(Alert.AlertType.WARNING, "Patvirtinkite", "Ar tikrai norite ištrinti įrašą? "),
